...
<html>
    ...
    <body style="background:url(bgImages/body-bg-tl.jpg) fixed">
        ...
        <div class="container" style="border: 3px solid black;border-radius:1.5em;background: white;" >
            <%request.setCharacterEncoding("UTF-8");%>
            <%response.setContentType("text/html; charset=UTF-8"); %>
                <div class="container" >
                    <div class="account">
                        <h2 class="account-in" style="color:#6b9876;font-size: 30px;padding: 0px;">Đăng Ký Tài Khoản</h2>
                        ...
                        <div>
                            <span class="mail" style="color:#6b9876;">Họ Và Tên:*</span>
                        ...
                        <div> 	
                            <span class="mail" style="color:#6b9876;">Email/Gmail*</span>
                        ...
                        <div>
                            <span style="color:#6b9876;">Username *</span>
                        ...
                        <div> 
                            <span class="word" style="color:#6b9876;">Password *</span>
                        ...
                        <div> 
                            <span class="word" style="color:#6b9876;">Nhập Lại Password *</span>
                        ...
                        <div> 
                            <span class="word" style="color:#6b9876;">Địa Chỉ</span>
                        ...
                        <div> 
                            <span class="word" style="color:#6b9876;">Số Điện Thoại</span>
                        ...
                        <input id="tb" style="background:#6b9876;;border:1px solid black;" type="submit" value="Đăng Ký"> 
                    </form>
                </div>
            </div>
        </div>
